import { ActionRowBuilder, ButtonBuilder, ButtonInteraction, ButtonStyle, CacheType, ChannelType, ChatInputCommandInteraction, CommandInteraction, EmbedBuilder, MessageContextMenuCommandInteraction, PermissionsBitField, TextChannel, UserContextMenuCommandInteraction } from "discord.js";
import { config } from "@/app";

export default async function createTicket(interaction: ChatInputCommandInteraction<CacheType> | MessageContextMenuCommandInteraction<CacheType> | UserContextMenuCommandInteraction<any> | ButtonInteraction<CacheType> | CommandInteraction<CacheType>) {
